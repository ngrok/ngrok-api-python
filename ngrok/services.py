...
class AbuseReportsClient(object):
    ...
    def create(self,
        ...
        """
        path = "/abuse_reports"
        result = self._client.post(path, dict(
            urls=urls,
            metadata=metadata,
        ))
        return AbuseReport(result)
    ...
    def get(self,
        ...
        result = self._client.get(path, dict(
        ))
        return AbuseReport(result)
...
class APIKeysClient(object):
    ...
    def update(self,
        ...
        result = self._client.patch(path, dict(
            description=description,
            metadata=metadata,
        ))
        return APIKey(result)
...
class CertificateAuthoritiesClient(object):
    ...
    def create(self,
        ...
        return CertificateAuthority(result)
    ...
    def list(self,
        ...
        return CertificateAuthorityList(result)
...
class EventDestinationsClient(object):
    ...
    def create(self,
        ...
        verify_with_test_event: bool = False,
    ) -> EventDestination:
        ...
        result = self._client.post(path, dict(
            ...
            format=format,
            target=target,
            verify_with_test_event=verify_with_test_event,
        ))
        return EventDestination(result)
    ...
    def list(self,
        ...
        return EventDestinationList(result)
    ...
    def send_test_event(self,
        ...
        :param id: a resource identifier
        """
        path = "/event_destinations/{id}/send_test_event"
        path = path.format(
            id=id,
        )
        result = self._client.post(path, dict(
        ))
        return SentEvent(result)
...
class IPPolicyRulesClient(object):
    ...
    def list(self,
        ...
        return IPPolicyRuleList(result)
...
class IPRestrictionsClient(object):
    ...
    def list(self,
        ...
        return IPRestrictionList(result)
...
class IPWhitelistClient(object):
    ...
    def create(self,
        ...
        return IPWhitelistEntry(result)
    ...
    def list(self,
        ...
        return IPWhitelistEntryList(result)
...
_Endpoints are your gateway to ngrok features!_ """
    ...
    def create(self,
        ...
        description: str = "",
        metadata: str = "",
        basic_auth: EndpointBasicAuth = None,
        ...
        :param basic_auth: basic auth module configuration or <code>null</code>
        ...
        return EndpointConfiguration(result)
    ...
    def list(self,
        ...
        return EndpointConfigurationList(result)
...
class EndpointLoggingModuleClient(object):
    ...
    def replace(self,
        ...
        result = self._client.put(path, dict(
            module=module,
        ))
        return EndpointLogging(result)
...
class EndpointCircuitBreakerModuleClient(object):
    ...
    def replace(self,
        ...
        return EndpointCircuitBreaker(result)
...
class EndpointCompressionModuleClient(object):
    ...
    def replace(self,
        ...
        return EndpointCompression(result)
...
class EndpointTLSTerminationModuleClient(object):
    ...
    def replace(self,
        ...
        return EndpointTLSTermination(result)
...
class EndpointIPPolicyModuleClient(object):
    ...
    def replace(self,
        ...
        return EndpointIPPolicy(result)
...
class EndpointMutualTLSModuleClient(object):
    ...
    def replace(self,
        ...
        return EndpointMutualTLS(result)
...
class EndpointRequestHeadersModuleClient(object):
    ...
    def replace(self,
        ...
        return EndpointRequestHeaders(result)
...
class EndpointResponseHeadersModuleClient(object):
    ...
    def replace(self,
        ...
        return EndpointResponseHeaders(result)
...
class EndpointWebhookValidationModuleClient(object):
    ...
    def replace(self,
        ...
        return EndpointWebhookValidation(result)
...
class ReservedAddrsClient(object):
    ...
    def list(self,
        ...
        return ReservedAddrList(result)
...
class ReservedDomainsClient(object):
    ...
    def list(self,
        ...
        return ReservedDomainList(result)
    ...
    def delete_certificate_management_policy(self,
        id: str,
    ):
    ...
    def delete_http_endpoint_config(self,
        id: str,
    ):
    ...
    def delete_https_endpoint_config(self,
        id: str,
    ):
...
class SSHCertificateAuthoritiesClient(object):
    ...
    def create(self,
        ...
        return SSHCertificateAuthority(result)
    ...
    def list(self,
        ...
        return SSHCertificateAuthorityList(result)
...
class SSHCredentialsClient(object):
    ...
    def list(self,
        ...
        return SSHCredentialList(result)
...
class SSHHostCertificatesClient(object):
    ...
    def create(self,
        ...
        return SSHHostCertificate(result)
    ...
    def list(self,
        ...
        return SSHHostCertificateList(result)
...
class SSHUserCertificatesClient(object):
    ...
    def create(self,
        ...
        return SSHUserCertificate(result)
    ...
    def list(self,
        ...
        return SSHUserCertificateList(result)
...
class TLSCertificatesClient(object):
    ...
    def list(self,
        ...
        return TLSCertificateList(result)
...
class TunnelSessionsClient(object):
    ...
    def list(self,
        ...
        return TunnelSessionList(result)
    ...
    def update(self,
        ...
        :param id: 
        :param version: request that the ngrok agent update to this specific version instead of the latest available version
        """
